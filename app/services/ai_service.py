...
def analyze_text_with_openai(text: str, prompt_type: str, settings) -> Optional[Dict[str, Any]]:
    """
...
def generate_bill_summary(bill_data: Dict[str, Any]) -> str:
    ...
    try:
        ...
        merchant = bill_data.get('merchant_name', bill_data.get('vendor_name', 'Unknown Merchant'))
